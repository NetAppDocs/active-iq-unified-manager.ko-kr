...
+
이 단계에서는 관련된 모든 NetApp RPM 패키지가 제거됩니다. Java, MySQL, 7zip 등의 필수 소프트웨어 모듈은 제거되지 않습니다.

. *선택 사항:* 해당되는 경우 Java, MySQL, 7zip 등의 지원 소프트웨어 모듈을 제거합니다.
+
