...
+
Red Hat Enterprise Linux 8 시스템의 경우 AppStream 저장소에서 제공하는 JDK 17 - OpenJDK, p7zip 및 기타 소프트웨어 패키지가 포함된 내부 저장소가 있는 경우 AppStream 저장소를 비활성화하고 MySQL Community Server를 설치해야 합니다. 다음 명령을 실행하세요.
