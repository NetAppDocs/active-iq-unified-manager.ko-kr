...
* MySQL Community Edition은 Unified Manager 업그레이드 중에 자동으로 업그레이드됩니다. 시스템에 설치된 MySQL 버전이 8.4.7 이전인 경우 Unified Manager 업그레이드 프로세스는 자동으로 MySQL을 8.4.7로 업그레이드합니다.
