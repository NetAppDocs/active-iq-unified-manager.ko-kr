...
---
= Active IQ Unified Manager 게이트웨이 API를 사용하여 ONTAP 볼륨 문제 해결
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/api_gateway_ontap_workflow.gif[Unified Manager 및 ONTAP API 단계를 보여주는 다이어그램으로, 볼륨 용량 경고 문제를 해결하기 위한 것입니다.]
