...
* ONTAP REST API의 사용에 대해 잘 알고 있습니다. ONTAP REST API 사용에 대한 자세한 내용은 _ONTAP REST API 개발자 가이드_를 참조하십시오.
+
https://docs.netapp.com/us-en/ontap-automation/index.html["ONTAP REST API 개발자 가이드"]
