...
---
= Active IQ Unified Manager API를 사용하여 CIFS 및 NFS 파일 공유를 프로비저닝합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/create_fileshares.gif[SVM 설정부터 공유 생성까지 CIFS 및 NFS 파일 공유 프로비저닝 워크플로를 보여주는 다이어그램]
