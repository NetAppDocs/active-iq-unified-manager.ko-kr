...
---
= Active IQ Unified Manager 이벤트 API를 사용하여 스토리지 오브젝트 문제를 파악합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/handling_event_related_issues_of_a_storage_object_flowchart.gif[이벤트 목록 작성부터 시정 조치, 최종 결과까지의 볼륨 이벤트 분석을 보여주는 흐름도]
