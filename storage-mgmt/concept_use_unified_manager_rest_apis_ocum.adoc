...
---
= Active IQ Unified Manager REST API 사용
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Unified Manager REST API에 대한 자세한 내용은 를 참조하십시오 link:../api-automation/concept_get_started_with_um_apis.html["Active IQ Unified Manager REST API 시작하기"].
