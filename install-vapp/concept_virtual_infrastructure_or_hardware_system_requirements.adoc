...
---
= Active IQ Unified Manager의 가상 인프라 및 하드웨어 요구 사항에 대해 알아보십시오
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
또한 Unified Manager의 두 번째 인스턴스를 설치하기 전에 단일 Unified Manager 인스턴스가 모니터링할 수 있는 노드 수에는 제한이 있습니다. 노드 제한, CPU 및 메모리 권장 사항에 대한 자세한 내용은 link:https://www.netapp.com/pdf.html?item=/media/13504-tr4621.pdf["통합 관리자 모범 사례 가이드"^]을 참조하십시오.
