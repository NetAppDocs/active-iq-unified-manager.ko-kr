...
또한 Unified Manager의 두 번째 인스턴스를 설치하기 전에 Unified Manager의 단일 인스턴스가 모니터링할 수 있는 노드 수에는 제한이 있습니다. 노드 제한, CPU 및 메모리 권장 사항은 다음을 참조하십시오. link:https://www.netapp.com/pdf.html?item=/media/13504-tr4621pdf.pdf["통합 관리자 모범 사례 가이드"^].
