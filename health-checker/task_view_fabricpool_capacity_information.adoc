...
---
= Active IQ Unified Manager에서 FabricPool 용량 정보 보기
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
FabricPool Aggregate에 대한 자세한 내용은 를 참조하십시오 https://docs.netapp.com/us-en/ontap/disks-aggregates/index.html["디스크 및 애그리게이트 개요"].
