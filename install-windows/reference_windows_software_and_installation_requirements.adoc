...
---
= Active IQ Unified Manager의 Windows 소프트웨어 및 설치 요구 사항 이해
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
:pp: &#43;&#43;
...
* Microsoft Visual C++ Redistributable Packages for Visual Studio 2015 버전 14.29.30133.0
* MySQL Community Edition 버전 8.4.10
* 파이썬 3.13.3
* OpenJDK 버전 17.0.15+6
* 7-zip 버전 25.01 이상
