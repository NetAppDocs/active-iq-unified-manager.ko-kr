...
---
= Windows에서 Active IQ Unified Manager용 OpenJDK 업그레이드
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
예를 들어, 다운로드 `jdk-17.0.15_windows-x64_bin.zip` 파일에서link:https://www.oracle.com/java/technologies/javase/jdk17-0-13-later-archive-downloads.html["Oracle Java SE 17 아카이브 다운로드 페이지"^] .

+

NOTE: 파일을 다운로드하려면 Oracle 계정이 필요합니다. Oracle 계정이 없으면 다음으로 이동하세요. link:https://signon.oracle.com/signin["Oracle 계정 로그인 페이지"] 하나를 만들려면.
